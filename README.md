...
The model is trained on the dataset introduced in the companion paper (Larosa et al., under review), available on HuggingFace at [links-ads/metop-era5-pblh](https://huggingface.co/datasets/links-ads/metop-era5-pblh).
